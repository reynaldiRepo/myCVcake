 ...
 * MydetailFixture
 */
class MydetailFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'id_user_ibfk2' => ['type' => 'index', 'columns' => ['id_user'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'id_user_ibfk2' => ['type' => 'foreign', 'columns' => ['id_user'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
