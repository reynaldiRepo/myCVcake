            ...
            <div class="row">
                <div class="col-lg-2 bor-r ">
                    <ul class="side-nav">
                        ...
                        <li class="active"><?= $this->Html->link('Tell Us About You', ['controller'=>'Mydetail','action' => 'index']) ?>
                        </li>
                ...
                <fieldset>
                    <legend><?= __('Is About You') ?></legend>
                    <?php
                        echo $this->Form->control('ket', ['label'=>'Tell us Whatever']);
                        echo "<script>
